...
describe('Endpoint Tests', () => {
    ...
    describe('Gets all articles filtered with sort-by of users choice & order which can be set to ASC or DESC', () => {
        test('Status 200: Succesfully Gets all articles filtered by sort_by of title and an order of ASC',()=>{
            return request(app)
    ...
    test('Status 200: Succesfully Gets all articles filtered by sort_by of votes',()=>{
        return request(app)
        .get('/api/articles?sort_by=title&order=ASC')
        .expect(200)
        .then((data) => {
